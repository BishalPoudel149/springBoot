...
import com.jcCoder.springboottut.dto.AuthResponseDTO;
import com.jcCoder.springboottut.dto.LoginDto;
import com.jcCoder.springboottut.dto.RegisterDto;
import com.jcCoder.springboottut.entity.UserEntity.Role;
import com.jcCoder.springboottut.entity.UserEntity.UserEntity;
import com.jcCoder.springboottut.repository.RoleRepository;
import com.jcCoder.springboottut.repository.UserRepository;
import com.jcCoder.springboottut.security.JWTProvider;
...
public class AuthController {
    ...
    public ResponseEntity<String> register(@RequestBody RegisterDto registerDto){
        ...
        return new ResponseEntity<>( registerDto.getUsername()+" User Registered !! ",HttpStatus.OK);
